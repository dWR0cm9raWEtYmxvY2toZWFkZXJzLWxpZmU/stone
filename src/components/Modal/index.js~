      ...
      <div>
        ...
        >
          <div style={getModalStyle()} className={classes.paper}>
            ...
            <br />
            <Typography className="name" id="simple-modal-description">
            ...
            <br />
            <Typography className="info" style={{ fontStyle: 'italic' }}>
              Full name, Gender, Date of Birth, Arrival date and departure date
            </Typography>
          </div>
        </Modal>
      </div>

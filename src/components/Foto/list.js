const list = {
  ...
  "v2": {
    ...
    "position": "CEO",
    "company": "Cryptonomex",
    "intro": "Forty years experience in software, hardware, systems engineering, program management, and business development. Contributed on 17 different R&D programs about air, ground, sea and space systems."    
  },
  "v3": {
    "name": "Fabian Schuh (Xeroc)",
    "position": "CTO",
    "company": "Blockchain Projects",
    "intro": "Dr. Fabian Schuh is an entrepreneur and fervent blockchain advocate.He has been technical consultant and developer for numerous projects throughout the blockchain ,advocating the advancement of blockchain technologies in Europe on a larger scale.",
  },
  "v4": {
    "name": "Ronny Boesing",
    "position": "CEO",
  ...
  "v5": {
    "name": "Harvey Zhao",
    "position": "Founder",
    "company": "CEO of OracleChain",
    "intro": "Harvey  came in contact with bitcoin in 2011 and participated several blockchain projects such as Peercoin/Factom/Bitshares. He has rich experience in blockchain."
  },
  "v6": {
    "name": "Minqiang Huang ",
    "position": "Founder and Chief ",
    "company": "Gxshares",
    "intro": "Minqiang has over 10 years’ experience in the field of data exchange, financial technology, and blockchain. He dived into cryptocurrency and blockchain in 2012,  initiated several projects as well. Minqiang’s expertise lies in design of blockchain product and digital currency economic models."
  },
  "v7": {
    "name": "Ryan R. Fox",
    "position": "Developer,witness",
    "company": "Bitshares",

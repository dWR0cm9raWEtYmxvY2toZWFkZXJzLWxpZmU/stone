...
const lookback = {
    ...
    para: "Bitshares、公信宝、Cybex、DECENT等12个优质区块链项目共聚上海，400+观众现场互动，探讨石墨烯技术的未来。"
}

const overview ={
    title: "全球大会概况",
    p1: '会议规模：1000+',
    p2: '会议时间：2018年5月4日-5月6日',
    p3: '会议地点：上海喜马拉雅酒店',
    p4: '目标群体：石墨烯技术开发者、区块链开发者、区块链相关从业者、区块链技术爱好者、区块链相关投资人',
    p5: '会议形式：主题演讲+圆桌论坛',
    p6: '主办方：BlockGeek、GDEX',
    p7: '协办方：Blockchain Centre China'
}

const star = {
    title: "大会亮点",
    p1: "闭门会议：与全球顶尖石墨烯技术开发者面对面交流",
    p2: "特色圆桌：比特股未来走势大论战",
    p3: "同声传译：让开发者间无障碍交流"
}
const vip = {
...
const cn = { intro, lookback, overview, star, vip, host, assist, partner }
